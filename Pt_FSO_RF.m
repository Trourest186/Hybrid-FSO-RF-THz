...
function  result = Pt_FSO_RF(SNR_av, SNR_thres)
...
[BER_RF, N] = RF_BER_av(m, fd, t_av, SNR_av, SNR_thres);
[BER_FSO, M] = FSO_BER_av(lamda, hv, H, t_av1, SNR_av);
disp(BER_FSO);
Pf = FSO_CSS_prob(lamda, hv, H, t_av1, SNR_av);
